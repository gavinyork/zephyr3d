...
/** @internal */
export function getBuiltinParamName(shaderType: ShaderType): string {
  switch (shaderType) {
...
/** @internal */
export function getBuiltinInputStructInstanceName(shaderType: ShaderType): string {
  switch (shaderType) {
    case ShaderType.Vertex:
...
/** @internal */
export function getBuiltinOutputStructInstanceName(shaderType: ShaderType): string {
  switch (shaderType) {
    case ShaderType.Vertex:
...
/** @internal */
export function getBuiltinInputStructName(shaderType: ShaderType): string {
  switch (shaderType) {
    case ShaderType.Vertex:
...
/** @internal */
export function getBuiltinOutputStructName(shaderType: ShaderType): string {
  switch (shaderType) {
    case ShaderType.Vertex:
...
export class ASTFunctionParameter extends ASTExpression {
  ...
  getAddressSpace(): Nullable<PBAddressSpace> {
...
export class ASTShaderExpConstructor extends ASTExpression {
  ...
  constExp: boolean;
  /** @internal */
  convertedArgs!: { name: string; args: ASTExpression[] };
...
export class ASTSelect extends ASTExpression {
  ...
  constructor(
    ...
    let firstType: Nullable<PBTypeInfo> = null;
    let secondType: Nullable<PBTypeInfo> = null;
...
export class ASTFunction extends ASTScope {
  ...
  name: string;
  /** @internal */
  args: Nullable<ASTFunctionParameter[]>;
  /** @internal */
  isBuiltin: boolean;
  /** @internal */
  isMainFunc: boolean;
  /** @internal */
  funcType: Nullable<PBFunctionTypeInfo>;
  /** @internal */
  builtins: string[];
  /** @internal */
  returnType: Nullable<PBTypeInfo>;
  constructor(
    name: string,
    args: Nullable<ASTFunctionParameter[]>,
    isMainFunc: boolean,
    type: Nullable<PBFunctionTypeInfo>,
    isBuiltin = false
  ) {
    super();
    this.name = name;
...
export class ASTIf extends ASTScope {
  ...
  keyword: string;
  /** @internal */
  condition: Nullable<ASTExpression>;
  /** @internal */
  nextElse: Nullable<ASTIf>;
  constructor(keyword: string, condition: Nullable<ASTExpression>) {
    super();
...
export class ASTDoWhile extends ASTScope {
  /** @internal */
  condition: Nullable<ASTExpression>;
  constructor(condition: Nullable<ASTExpression>) {
    super();
    this.condition = condition;
    if (this.condition instanceof ASTCallFunction) {
      this.condition.isStatement = false;
