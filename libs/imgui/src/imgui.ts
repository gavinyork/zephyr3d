...
function import_Scalar(
  sca:
    | XY
    | XYZ
    | XYZW
    | Bind.ImAccess<number>
    | Bind.ImScalar<number>
    | Bind.ImTuple2<number>
    | Bind.ImTuple3<number>
    | Bind.ImTuple4<number>
    | Bind.interface_ImVec4
): Bind.ImScalar<number> {
...
function export_Scalar(
  tuple: Bind.ImScalar<number>,
  sca:
    | XY
    | XYZ
    | XYZW
...
function export_Vector2(
  tuple: Bind.ImTuple2<number>,
  vec:
    | XY
    | XYZ
    | XYZW
...
function import_Vector3(
  vec: XYZ | XYZW | Bind.ImTuple3<number> | Bind.ImTuple4<number> | Bind.interface_ImVec4
): Bind.ImTuple3<number> {
  if (Array.isArray(vec)) {
...
function export_Vector3(
  tuple: Bind.ImTuple3<number>,
  vec: XYZ | XYZW | Bind.ImTuple3<number> | Bind.ImTuple4<number> | Bind.interface_ImVec4
): void {
  if (Array.isArray(vec)) {
    vec[0] = tuple[0];
...
function import_Vector4(
  vec: XYZW | Bind.ImTuple3<number> | Bind.ImTuple4<number> | Bind.interface_ImVec4
): Bind.ImTuple4<number> {
  if (Array.isArray(vec)) {
...
function export_Vector4(
  tuple: Bind.ImTuple4<number>,
  vec: XYZW | Bind.ImTuple3<number> | Bind.ImTuple4<number> | Bind.interface_ImVec4
): void {
  if (Array.isArray(vec)) {
    vec[0] = tuple[0];
...
function import_Color3(
  col: RGB | RGBA | Bind.ImTuple3<number> | Bind.ImTuple4<number> | Bind.interface_ImVec4
): Bind.ImTuple3<number> {
...
function import_Color4(
  col: RGBA | Bind.ImTuple4<number> | Bind.interface_ImVec4 | RGBA
): Bind.ImTuple4<number> {
  if (Array.isArray(col)) {
...
export type ImTextureID = Texture2D;
...
export const IM_COL32_WHITE: number = IM_COL32(255, 255, 255, 255);
export { IM_COL32_WHITE as COL32_WHITE }; // Opaque white = 0xFFFFFFFF
export const IM_COL32_BLACK: number = IM_COL32(0, 0, 0, 255);
export { IM_COL32_BLACK as COL32_BLACK }; // Opaque black
export const IM_COL32_BLACK_TRANS: number = IM_COL32(0, 0, 0, 0);
...
export class ImColor {
  ...
  public toImU32(): Bind.ImU32 {
    return ColorConvertFloat4ToU32(this.Value);
  }
  // inline operator ImVec4() const                                  { return Value; }
  public toImVec4(): ImVec4 {
    return this.Value;
  }
...
export class ImGuiInputTextCallbackData<T> {
  constructor(
    public readonly native: Bind.reference_ImGuiInputTextCallbackData,
    public readonly UserData: T | null = null
  ) {}

  // ImGuiInputTextFlags EventFlag;      // One of ImGuiInputTextFlags_Callback* // Read-only
  public get EventFlag(): ImGuiInputTextFlags {
    return this.native.EventFlag;
  }
  // ImGuiInputTextFlags Flags;          // What user passed to InputText()      // Read-only
  public get Flags(): ImGuiInputTextFlags {
  ...
  public get EventChar(): Bind.ImWchar {
    return this.native.EventChar;
  }
  public set EventChar(value: Bind.ImWchar) {
    this.native.EventChar = value;
  }

  // Completion,History,Always events:
  // If you modify the buffer contents make sure you update 'BufTextLen' and set 'BufDirty' to true.
  // ImGuiKey            EventKey;       // Key pressed (Up/Down/TAB)            // Read-only
  public get EventKey(): ImGuiKey {
    return this.native.EventKey;
  }
  // char*               Buf;            // Current text buffer                  // Read-write (pointed data only, can't replace the actual pointer)
  public get Buf(): string {
    return this.native.Buf;
  }
  public set Buf(value: string) {
    this.native.Buf = value;
  }
  // int                 BufTextLen;     // Current text length in bytes         // Read-write
  public get BufTextLen(): number {
    return this.native.BufTextLen;
  }
  public set BufTextLen(value: number) {
    this.native.BufTextLen = value;
  }
  // int                 BufSize;        // Maximum text length in bytes         // Read-only
  public get BufSize(): number {
    return this.native.BufSize;
  }
  // bool                BufDirty;       // Set if you modify Buf/BufTextLen!!   // Write
  public set BufDirty(value: boolean) {
    this.native.BufDirty = value;
  }
  // int                 CursorPos;      //                                      // Read-write
  public get CursorPos(): number {
    return this.native.CursorPos;
  }
  public set CursorPos(value: number) {
    this.native.CursorPos = value;
  }
  ...
  public DeleteChars(pos: number, bytes_count: number): void {
    return this.native.DeleteChars(pos, bytes_count);
  }
  // IMGUI_API void    InsertChars(int pos, const char* text, const char* text_end = NULL);
  public InsertChars(pos: number, text: string, text_end: number | null = null): void {
...
export class ImGuiSizeCallbackData<T> {
  ...
  get CurrentSize(): Readonly<Bind.interface_ImVec2> {
    return this.native.CurrentSize;
  }
  get DesiredSize(): Bind.interface_ImVec2 {
    return this.native.DesiredSize;
  }
}
...
export class ImGuiTableColumnSortSpecs {
  ...
  get ColumnUserID(): ImGuiID {
    return this.native.ColumnUserID;
  }
  get ColumnIndex(): Bind.ImS16 {
    return this.native.ColumnIndex;
  }
  get SortOrder(): Bind.ImS16 {
    return this.native.SortOrder;
  }
  get SortDirection(): ImGuiSortDirection {
    return this.native.SortDirection;
  }
}
...
export class ImGuiTableSortSpecs {
  ...
  get SpecsCount(): number {
    return this.native.SpecsCount;
  }
  get SpecsDirty(): boolean {
    return this.native.SpecsDirty;
  }
  set SpecsDirty(value: boolean) {
    this.native.SpecsDirty = value;
  }
}
...
export class ImGuiListClipper {
  ...
  public get DisplayStart(): number {
    return this.native.DisplayStart;
  }
  public get DisplayEnd(): number {
    return this.native.DisplayEnd;
  }

  public get ItemsCount(): number {
    return this.native.ItemsCount;
  }
  public get StepNo(): number {
    return this.native.StepNo;
  }
  public get ItemsFrozen(): number {
    return this.native.ItemsFrozen;
  }
  public get ItemsHeight(): number {
    return this.native.ItemsHeight;
  }
  public get StartPosY(): number {
    return this.native.StartPosY;
  }
...
export class ImDrawList {
  ...
  public PushClipRect(
    clip_rect_min: Readonly<Bind.interface_ImVec2>,
    clip_rect_max: Readonly<Bind.interface_ImVec2>,
  ...
  public AddLine(
    a: Readonly<Bind.interface_ImVec2>,
    b: Readonly<Bind.interface_ImVec2>,
    col: Bind.ImU32,
    thickness = 1.0
  ): void {
  ...
  public AddRect(
    ...
    col: Bind.ImU32,
    rounding = 0.0,
    rounding_corners_flags: ImDrawCornerFlags = ImDrawCornerFlags.All,
    thickness = 1.0
  ): void {
    this.native.AddRect(a, b, col, rounding, rounding_corners_flags, thickness);
  }
  // IMGUI_API void  AddRectFilled(const ImVec2& a, const ImVec2& b, ImU32 col, float rounding = 0.0f, int rounding_corners_flags = ImDrawCornerFlags_All);                     // a: upper-left, b: lower-right
  public AddRectFilled(
    a: Readonly<Bind.interface_ImVec2>,
    b: Readonly<Bind.interface_ImVec2>,
    col: Bind.ImU32,
    rounding = 0.0,
  ...
  public AddRectFilledMultiColor(
    a: Readonly<Bind.interface_ImVec2>,
    b: Readonly<Bind.interface_ImVec2>,
    col_upr_left: Bind.ImU32,
    col_upr_right: Bind.ImU32,
    col_bot_right: Bind.ImU32,
    col_bot_left: Bind.ImU32
  ): void {
  ...
  public AddQuad(
    a: Readonly<Bind.interface_ImVec2>,
    b: Readonly<Bind.interface_ImVec2>,
    c: Readonly<Bind.interface_ImVec2>,
    d: Readonly<Bind.interface_ImVec2>,
    col: Bind.ImU32,
    thickness = 1.0
  ): void {
  ...
  public AddCircle(
    centre: Readonly<Bind.interface_ImVec2>,
    radius: number,
    col: Bind.ImU32,
    num_segments = 12,
    thickness = 1.0
  ...
  public AddText(
    ...
    text_end?: number | null,
    wrap_width?: number,
    cpu_fine_clip_rect?: Readonly<Bind.interface_ImVec4> | null
  ): void;
  public AddText(...args: any[]): void {
    if (args[0] instanceof ImFont) {
      ...
      this.native.AddText_B(
        font.native,
        font_size,
        pos,
        col,
        text_end !== null ? text_begin.substring(0, text_end) : text_begin,
        wrap_width,
        cpu_fine_clip_rect
      );
    } else {
  ...
  public AddPolyline(
    points: Array<Readonly<Bind.interface_ImVec2>>,
    num_points: number,
    col: Bind.ImU32,
    closed: boolean,
    thickness: number
  ...
  public AddBezierCubic(
    p1: Readonly<Bind.interface_ImVec2>,
    p2: Readonly<Bind.interface_ImVec2>,
    p3: Readonly<Bind.interface_ImVec2>,
    p4: Readonly<Bind.interface_ImVec2>,
    col: Bind.ImU32,
    thickness = 1.0,
    num_segments = 0
  ): void {
  ...
  public AddImage(
    user_texture_id: ImTextureID | null,
    a: Readonly<Bind.interface_ImVec2>,
    b: Readonly<Bind.interface_ImVec2>,
    uv_a: Readonly<Bind.interface_ImVec2> = ImVec2.ZERO,
    uv_b: Readonly<Bind.interface_ImVec2> = ImVec2.UNIT,
    col: Bind.ImU32 = 0xffffffff
  ): void {
  ...
  public AddImageQuad(
    ...
    d: Readonly<Bind.interface_ImVec2>,
    uv_a: Readonly<Bind.interface_ImVec2> = ImVec2.ZERO,
    uv_b: Readonly<Bind.interface_ImVec2> = ImVec2.UNIT_X,
    uv_c: Readonly<Bind.interface_ImVec2> = ImVec2.UNIT,
    uv_d: Readonly<Bind.interface_ImVec2> = ImVec2.UNIT_Y,
    col: Bind.ImU32 = 0xffffffff
  ): void {
    this.native.AddImageQuad(
      ImGuiContext.setTexture(user_texture_id),
      a,
      b,
      c,
      d,
  ...
  public AddImageRounded(
    user_texture_id: ImTextureID | null,
    a: Readonly<Bind.interface_ImVec2>,
    b: Readonly<Bind.interface_ImVec2>,
    uv_a: Readonly<Bind.interface_ImVec2>,
    uv_b: Readonly<Bind.interface_ImVec2>,
    col: Bind.ImU32,
    rounding: number,
    rounding_corners: ImDrawCornerFlags = ImDrawCornerFlags.All
  ): void {
    this.native.AddImageRounded(
      ImGuiContext.setTexture(user_texture_id),
      a,
      b,
      uv_a,
  ...
  public PathLineTo(pos: Readonly<Bind.interface_ImVec2>): void {
    this.native.PathLineTo(pos);
  }
  // inline    void  PathLineToMergeDuplicate(const ImVec2& pos)                 { if (_Path.Size == 0 || memcmp(&_Path[_Path.Size-1], &pos, 8) != 0) _Path.push_back(pos); }
  public PathLineToMergeDuplicate(pos: Readonly<Bind.interface_ImVec2>): void {
    this.native.PathLineToMergeDuplicate(pos);
  }
  // inline    void  PathFillConvex(ImU32 col)                                   { AddConvexPolyFilled(_Path.Data, _Path.Size, col); PathClear(); }
  public PathFillConvex(col: Bind.ImU32): void {
    this.native.PathFillConvex(col);
  }
  // inline    void  PathStroke(ImU32 col, bool closed, float thickness = 1.0f)  { AddPolyline(_Path.Data, _Path.Size, col, closed, thickness); PathClear(); }
  public PathStroke(col: Bind.ImU32, closed: boolean, thickness = 1.0): void {
  ...
  public PathBezierQuadraticCurveTo(
    p2: Readonly<Bind.interface_ImVec2>,
    p3: Readonly<Bind.interface_ImVec2>,
    num_segments = 0
  ): void {
  ...
  public PathRect(
    rect_min: Readonly<Bind.interface_ImVec2>,
    rect_max: Readonly<Bind.interface_ImVec2>,
    rounding = 0.0,
    rounding_corners_flags: ImDrawCornerFlags = ImDrawCornerFlags.All
  ): void {
  ...
  public AddCallback(callback: ImDrawCallback, callback_data: any): void {
    const _callback: Bind.ImDrawCallback = (
      parent_list: Readonly<Bind.reference_ImDrawList>,
      draw_cmd: Readonly<Bind.reference_ImDrawCmd>
    ): void => {
  ...
  public PrimQuadUV(
    ...
    uv_a: Readonly<Bind.interface_ImVec2>,
    uv_b: Readonly<Bind.interface_ImVec2>,
    uv_c: Readonly<Bind.interface_ImVec2>,
    uv_d: Readonly<Bind.interface_ImVec2>,
    col: Bind.ImU32
  ): void {
  ...
  public PrimWriteVtx(
    pos: Readonly<Bind.interface_ImVec2>,
    uv: Readonly<Bind.interface_ImVec2>,
    col: Bind.ImU32
  ): void {
    this.native.PrimWriteVtx(pos, uv, col);
  }
  // inline    void  PrimWriteIdx(ImDrawIdx idx)                                 { *_IdxWritePtr = idx; _IdxWritePtr++; }
  public PrimWriteIdx(idx: ImDrawIdx): void {
...
export class ImFontAtlas {
  ...
  public AddFontFromMemoryTTF(
    ...
    return new ImFont(
      this.native.AddFontFromMemoryTTF(
        new Uint8Array(data),
        size_pixels,
        font_cfg && font_cfg.internal,
        glyph_ranges
      )
    );
  }
  ...
  public SetTexID(id: ImTextureID | null): void {
    this.TexID = id;
  }
...
export class ImFont {
  ...
  get SpaceX(): number[] {
    return [this.native.SpaceX0, this.native.SpaceX1];
  }
  set SpaceX(v: number[]) {
  ...
  public CalcTextSizeA(
    size: number,
    max_width: number,
    wrap_width: number,
    text_begin: string,
    text_end: number | null = null,
    remaining: Bind.ImScalar<number> | null = null,
    isready: Bind.ImScalar<boolean> | null = null
  ): Bind.interface_ImVec2 {
    return this.native.CalcTextSizeA(
      size,
      max_width,
      wrap_width,
      text_end !== null ? text_begin.substring(0, text_end) : text_begin,
  ...
  public CalcWordWrapPositionA(
    scale: number,
    text: string,
    text_end: number | null = null,
    wrap_width: number
  ): number {
    return this.native.CalcWordWrapPositionA(
      scale,
      text_end !== null ? text.substring(0, text_end) : text,
      wrap_width
    );
  }
...
class script_ImGuiStyle implements Bind.interface_ImGuiStyle {
  ...
  public _setAt_Colors(index: number, color: Readonly<Bind.interface_ImVec4>): boolean {
...
export class ImGuiStyle {
  ...
  public Colors: Bind.interface_ImVec4[] = new Proxy([], {
    ...
    set: (
      target: Bind.interface_ImVec4[],
      key: PropertyKey,
      value: Readonly<Bind.interface_ImVec4>
    ): boolean => {
...
export class ImGuiIO {
  ...
  public set MouseWheel(value: number) {
    this.native.MouseWheel = value;
  }
  // float       MouseWheelH;                    // Mouse wheel (Horizontal). Most users don't have a mouse with an horizontal wheel, may not be filled by all back-ends.
  public get MouseWheelH(): number {
    return this.native.MouseWheelH;
  }
  public set MouseWheelH(value: number) {
  ...
  public MouseClickedPos: Array<Readonly<Bind.reference_ImVec2>> = new Proxy([], {
    get: (
      target: Array<Readonly<Bind.reference_ImVec2>>,
      key: PropertyKey
    ): number | Readonly<Bind.reference_ImVec2> => {
      if (key === 'length') {
        return 5;
      }
...
export function CreateContext(shared_font_atlas: ImFontAtlas | null = null): ImGuiContext | null {
  const ctx: ImGuiContext = new ImGuiContext(
    bind.CreateContext(shared_font_atlas !== null ? shared_font_atlas.native : null)
  );
  if (ImGuiContext.current_ctx === null) {
...
export function ShowDemoWindow(p_open: Bind.ImScalar<boolean> | null = null): void {
  bind.ShowDemoWindow(p_open);
}
export function ShowMetricsWindow(
  p_open: Bind.ImScalar<boolean> | Bind.ImAccess<boolean> | null = null
): void {
  if (p_open === null) {
...
export function ShowStyleSelector(label: string): boolean {
  return bind.ShowStyleSelector(label);
}
export function ShowFontSelector(label: string): void {
  bind.ShowFontSelector(label);
}
...
export function Begin(
  name: string,
  open: Bind.ImScalar<boolean> | Bind.ImAccess<boolean> | null = null,
...
export function BeginChild(
  id: string | ImGuiID,
  size: Readonly<Bind.interface_ImVec2> = ImVec2.ZERO,
  border = false,
  flags: ImGuiWindowFlags = 0
): boolean {
...
function calculateSecionBoundsX(padding: number) {
  const window = GetCurrentWindow();
  const start = GetWindowPos().x;
  return [
    start + window.WindowPadding.x + padding,
    start + GetWindowWidth() - window.WindowPadding.x - padding
  ];
}

export function BeginStatusBar() {
...
export function EndStatusBar() {
  EndMenuBar();
  End();
}

export function BeginSection(title: string) {
  ...
  PushClipRect(
    new ImVec2(boundsX[0], window.ClipRect.Min.y),
    new ImVec2(midPoint, window.ClipRect.Max.y),
    false
  );
  Text(title);
  PopClipRect();
  ...
  PushClipRect(
    new ImVec2(boundsX[0], window.ClipRect.Min.y),
    new ImVec2(boundsX[1], window.ClipRect.Max.y),
    false
  );
...
export function EndSection(borderSize?: number, rounding?: number) {
  ...
  GetWindowDrawList().AddRectFilled(
    panelMin,
    panelMax,
    GetColorU32(GetStyleColorVec4(ImGuiCol.ChildBg)),
    rounding
  );
  if (borderSize > 0) {
    GetWindowDrawList().AddRect(
      panelMin,
      panelMax,
      GetColorU32(GetStyleColorVec4(ImGuiCol.Border)),
      rounding,
...
export function IsWindowAppearing(): boolean {
  return bind.IsWindowAppearing();
}
export function IsWindowCollapsed(): boolean {
  return bind.IsWindowCollapsed();
}
...
export function SetNextWindowPos(
  pos: Readonly<Bind.interface_ImVec2>,
  cond: ImGuiCond = 0,
  pivot: Readonly<Bind.interface_ImVec2> = ImVec2.ZERO
): void {
...
export function SetNextWindowSizeConstraints(
  size_min: Readonly<Bind.interface_ImVec2>,
  size_max: Readonly<Bind.interface_ImVec2>
): void;
export function SetNextWindowSizeConstraints<T>(
  size_min: Readonly<Bind.interface_ImVec2>,
  size_max: Readonly<Bind.interface_ImVec2>,
  custom_callback: ImGuiSizeCallback<T>,
  custom_callback_data?: T
): void;
export function SetNextWindowSizeConstraints<T>(
  size_min: Readonly<Bind.interface_ImVec2>,
  size_max: Readonly<Bind.interface_ImVec2>,
  custom_callback: ImGuiSizeCallback<T | null> | null = null,
  custom_callback_data: T | null = null
): void {
  if (custom_callback) {
    bind.SetNextWindowSizeConstraints(
      size_min,
      size_max,
      (data: Bind.reference_ImGuiSizeCallbackData): void => {
...
export function SetNextWindowFocus(): void {
  bind.SetNextWindowFocus();
}
export function SetNextWindowBgAlpha(alpha: number): void {
  bind.SetNextWindowBgAlpha(alpha);
}
export function SetWindowPos(
  name_or_pos: string | Readonly<Bind.interface_ImVec2>,
  pos_or_cond: Readonly<Bind.interface_ImVec2> | ImGuiCond = 0,
  cond: ImGuiCond = 0
): void {
...
export function SetWindowSize(
  name_or_size: string | Readonly<Bind.interface_ImVec2>,
  size_or_cond: Readonly<Bind.interface_ImVec2> | ImGuiCond = 0,
  cond: ImGuiCond = 0
): void {
...
export function SetWindowCollapsed(
  name_or_collapsed: string | boolean,
  collapsed_or_cond: boolean | ImGuiCond = 0,
  cond: ImGuiCond = 0
): void {
...
export function GetScrollX(): number {
  return bind.GetScrollX();
}
export function GetScrollY(): number {
  return bind.GetScrollY();
}
export function SetScrollX(scroll_x: number): void {
  bind.SetScrollX(scroll_x);
}
export function SetScrollY(scroll_y: number): void {
  bind.SetScrollY(scroll_y);
}
export function GetScrollMaxX(): number {
  return bind.GetScrollMaxX();
}
export function GetScrollMaxY(): number {
  return bind.GetScrollMaxY();
}
export function SetScrollHereX(center_x_ratio = 0.5): void {
  bind.SetScrollHereX(center_x_ratio);
}
export function SetScrollHereY(center_y_ratio = 0.5): void {
  bind.SetScrollHereY(center_y_ratio);
}
export function SetScrollFromPosX(pos_x: number, center_x_ratio = 0.5): void {
  bind.SetScrollFromPosX(pos_x, center_x_ratio);
}
export function SetScrollFromPosY(pos_y: number, center_y_ratio = 0.5): void {
...
export function PushFont(font: ImFont | null): void {
  bind.PushFont(font ? font.native : null);
}
export function PopFont(): void {
  bind.PopFont();
}
export function PushStyleColor(
  idx: ImGuiCol,
  col: Bind.ImU32 | Readonly<Bind.interface_ImVec4> | Readonly<ImColor>
): void {
...
export function PopStyleColor(count = 1): void {
...
export function CalcItemWidth(): number {
  return bind.CalcItemWidth();
}
export function PushTextWrapPos(wrap_pos_x = 0.0): void {
...
export function SameLine(pos_x = 0.0, spacing_w = -1.0): void {
...
export function Indent(indent_w = 0.0) {
  bind.Indent(indent_w);
}
export function Unindent(indent_w = 0.0) {
...
export function GetCursorPos(out: Bind.interface_ImVec2 = new ImVec2()): Bind.interface_ImVec2 {
  return bind.GetCursorPos(out);
}
export function GetCursorPosX(): number {
  return bind.GetCursorPosX();
}
...
export function TextUnformatted(text: string, text_end: number | null = null): void {
...
export function SmallButton(label: string): boolean {
  return bind.SmallButton(label);
}
export function ArrowButton(str_id: string, dir: ImGuiDir): boolean {
  return bind.ArrowButton(str_id, dir);
}
export function InvisibleButton(
  str_id: string,
  size: Readonly<Bind.interface_ImVec2>,
...
export function Image(
  user_texture_id: ImTextureID | null,
  size: Readonly<Bind.interface_ImVec2>,
  uv0: Readonly<Bind.interface_ImVec2> = ImVec2.ZERO,
  uv1: Readonly<Bind.interface_ImVec2> = ImVec2.UNIT,
  tint_col: Readonly<Bind.interface_ImVec4> = ImVec4.WHITE,
  border_col: Readonly<Bind.interface_ImVec4> = ImVec4.ZERO
): void {
  bind.Image(ImGuiContext.setTexture(user_texture_id), size, uv0, uv1, tint_col, border_col);
}
export function ImageButton(
  user_texture_id: ImTextureID | null,
  size: Readonly<Bind.interface_ImVec2> = new ImVec2(Number.MIN_SAFE_INTEGER, 0),
  uv0: Readonly<Bind.interface_ImVec2> = ImVec2.ZERO,
  uv1: Readonly<Bind.interface_ImVec2> = ImVec2.UNIT,
  frame_padding = -1,
  bg_col: Readonly<Bind.interface_ImVec4> = ImVec4.ZERO,
  tint_col: Readonly<Bind.interface_ImVec4> = ImVec4.WHITE
): boolean {
...
export function CheckboxFlags(
  label: string,
  flags: Bind.ImAccess<number> | Bind.ImScalar<number>,
  flags_value: number
): boolean {
...
export function RadioButton(
  label: string,
  v: Bind.ImAccess<number> | Bind.ImScalar<number>,
  v_button: number
): boolean;
...
export function ProgressBar(
  fraction: number,
  size_arg: Readonly<Bind.interface_ImVec2> = new ImVec2(-1, 0),
...
export function BeginCombo(
  label: string,
  preview_value: string | null = null,
...
export function Combo(
  label: string,
  current_item: Bind.ImAccess<number> | Bind.ImScalar<number>,
  items: string[],
  items_count?: number,
...
export function Combo<T>(
  label: string,
  current_item: Bind.ImAccess<number> | Bind.ImScalar<number>,
  items_getter: ComboValueGetter<T>,
  data: T,
  items_count: number,
  popup_max_height_in_items?: number
): boolean;
export function Combo<T>(
  ...
  if (Array.isArray(args[0])) {
    ...
    const items_getter = (data: null, idx: number, out_text: [string]): boolean => {
...
export function DragFloat2(
  label: string,
  v: XY | XYZ | XYZW | Bind.ImTuple2<number> | Bind.ImTuple3<number> | Bind.ImTuple4<number> | ImVec2,
  v_speed = 1.0,
  v_min = 0.0,
  v_max = 0.0,
  display_format = '%.3f',
...
export function DragFloat3(
  label: string,
  v: XYZ | XYZW | Bind.ImTuple3<number> | Bind.ImTuple4<number>,
  v_speed = 1.0,
  v_min = 0.0,
  v_max = 0.0,
  display_format = '%.3f',
...
export function DragFloat4(
  label: string,
  v: XYZW | Bind.ImTuple4<number> | ImVec4,
  v_speed = 1.0,
  v_min = 0.0,
  v_max = 0.0,
  display_format = '%.3f',
...
export function DragInt2(
  label: string,
  v: XY | XYZ | XYZW | Bind.ImTuple2<number> | Bind.ImTuple3<number> | Bind.ImTuple4<number>,
  v_speed = 1.0,
  v_min = 0,
  v_max = 0,
  format = '%d',
...
export function DragIntRange2(
  ...
  v_max = 0,
  format = '%d',
  format_max: string | null = null,
  flags: ImGuiSliderFlags = 0
): boolean {
  const _v_current_min = import_Scalar(v_current_min);
  const _v_current_max = import_Scalar(v_current_max);
  const ret = bind.DragIntRange2(
    label,
    _v_current_min,
    _v_current_max,
    v_speed,
...
export function SliderFloat4(
  label: string,
  v: XYZW | Bind.ImTuple4<number> | XYZW,
  v_min: number,
  v_max: number,
  format = '%.3f',
  flags: ImGuiSliderFlags = 0
...
export function SliderAngle3(
  label: string,
  v_rad: XYZ | XYZW | Bind.ImTuple3<number> | Bind.ImTuple4<number>,
  v_degrees_min = -360.0,
  v_degrees_max = +360.0,
  format = '%.0f deg',
  flags: ImGuiSliderFlags = 0
...
export function InputText<T>(
  label: string,
  buf: ImStringBuffer | Bind.ImAccess<string> | Bind.ImScalar<string>,
  buf_size: number = buf instanceof ImStringBuffer ? buf.size : ImGuiInputTextDefaultSize,
  flags: ImGuiInputTextFlags = 0,
  callback: ImGuiInputTextCallback<T> | null = null,
  user_data: T | null = null
): boolean {
  let ret = false;
  const _callback =
    (callback &&
      ((data: Bind.reference_ImGuiInputTextCallbackData): number =>
        callback(new ImGuiInputTextCallbackData<T>(data, user_data)))) ||
    null;
...
export function InputTextMultiline<T>(
  label: string,
  buf: ImStringBuffer | Bind.ImAccess<string> | Bind.ImScalar<string>,
  buf_size: number = buf instanceof ImStringBuffer ? buf.size : ImGuiInputTextDefaultSize,
  size: Readonly<Bind.interface_ImVec2> = ImVec2.ZERO,
...
export function InputTextWithHint<T>(
  label: string,
  hint: string,
  buf: ImStringBuffer | Bind.ImAccess<string> | Bind.ImScalar<string>,
  buf_size: number = buf instanceof ImStringBuffer ? buf.size : ImGuiInputTextDefaultSize,
...
export function ColorEdit4(
  label: string,
  col: RGBA | Bind.ImTuple4<number> | Bind.interface_ImVec4,
  flags: ImGuiColorEditFlags = 0
): boolean {
...
export function ColorPicker4(
  ...
  col: RGBA | Bind.ImTuple4<number> | Bind.interface_ImVec4,
  flags: ImGuiColorEditFlags = 0,
  ref_col: Bind.ImTuple4<number> | Bind.interface_ImVec4 | null = null
): boolean {
  const _col = import_Color4(col);
...
export function ColorButton(
  desc_id: string,
  col: Readonly<Bind.interface_ImVec4>,
  flags: ImGuiColorEditFlags = 0,
  size: Readonly<Bind.interface_ImVec2> = ImVec2.ZERO
): boolean {
...
export function GetTreeNodeToLabelSpacing(): number {
  return bind.GetTreeNodeToLabelSpacing();
}
export function CollapsingHeader(label: string, flags?: ImGuiTreeNodeFlags): boolean;
export function CollapsingHeader(
  label: string,
  p_open: Bind.ImScalar<boolean> | Bind.ImAccess<boolean>,
...
export function Selectable(
  label: string,
  p_selected: Bind.ImScalar<boolean> | Bind.ImAccess<boolean>,
  flags?: ImGuiSelectableFlags,
  size?: Readonly<Bind.interface_ImVec2>
): boolean;
...
export function ListBox<T>(
  label: string,
  current_item: Bind.ImAccess<number> | Bind.ImScalar<number>,
  items_getter: ListBoxItemGetter<T>,
  data: T,
  items_count: number,
  height_in_items?: number
): boolean;
...
export function PlotLines(
  ...
  scale_min?: number,
  scale_max?: number,
  graph_size?: Readonly<Bind.interface_ImVec2>,
  stride?: number
): void;
export function PlotLines<T>(
  label: string,
  values_getter: PlotLinesValueGetter<T>,
  data: T,
  values_count?: number,
  value_offset?: number,
  overlay_text?: string | null,
...
export function PlotLines<T>(label: string, ...args: any[]): void {
  if (Array.isArray(args[0])) {
    ...
    const values_getter: PlotLinesValueGetter<null> = (data: null, idx: number): number =>
      values[idx * stride];
...
export function PlotHistogram<T>(
  label: string,
  values_getter: PlotHistogramValueGetter<T>,
  data: T,
  values_count?: number,
  value_offset?: number,
  overlay_text?: string | null,
...
export function PlotHistogram<T>(label: string, ...args: any[]): void {
  if (Array.isArray(args[0])) {
    const values: ArrayLike<number> = args[0];
    const values_getter: PlotHistogramValueGetter<null> = (data: null, idx: number): number =>
      values[idx * stride];
    const values_count: number = typeof args[1] === 'number' ? args[1] : values.length;
    const values_offset: number = typeof args[2] === 'number' ? args[2] : 0;
    const overlay_text: string | null = typeof args[3] === 'string' ? args[3] : null;
...
export function BeginMainMenuBar(): boolean {
  return bind.BeginMainMenuBar();
}
export function EndMainMenuBar(): void {
  bind.EndMainMenuBar();
}
export function BeginMenu(label: string, enabled = true): boolean {
...
export function MenuItem(
  label: string,
  shortcut: string | null,
  p_selected: Bind.ImScalar<boolean> | Bind.ImAccess<boolean> | null,
  enabled?: boolean
): boolean;
...
export function BeginPopup(str_id: string, flags: ImGuiWindowFlags = 0): boolean {
...
export function OpenPopup(str_id: string, popup_flags: ImGuiPopupFlags = 0): void {
...
export function IsPopupOpen(str_id: string, flags: ImGuiPopupFlags = 0): boolean {
...
export function BeginTable(
  ...
  outer_size: Bind.interface_ImVec2 = ImVec2.ZERO,
  inner_width = 0.0
): boolean {
...
export function TableNextColumn(): boolean {
  return bind.TableNextColumn();
}
export function TableSetColumnIndex(column_n: number): boolean {
  return bind.TableSetColumnIndex(column_n);
}
...
export function TableGetColumnCount(): number {
  return bind.TableGetColumnCount();
}
export function TableGetColumnIndex(): number {
  return bind.TableGetColumnIndex();
}
export function TableGetRowIndex(): number {
  return bind.TableGetRowIndex();
}
export function TableGetColumnName(column_n = -1): string {
...
export function TableSetBgColor(target: ImGuiTableBgTarget, color: Bind.ImU32, column_n = -1) {
...
export function Columns(count = 1, id: string | null = null, border = true): void {
...
export function BeginTabBar(str_id: string, flags: ImGuiTabBarFlags = 0): boolean {
...
export function TabItemButton(label: string, flags: ImGuiTabItemFlags = 0): boolean {
  return bind.TabItemButton(label, flags);
}
export function SetTabItemClosed(tab_or_docked_window_label: string): void {
  bind.SetTabItemClosed(tab_or_docked_window_label);
}
...
export function LogToTTY(max_depth = -1): void {
  bind.LogToTTY(max_depth);
}
export function LogToFile(max_depth = -1, filename: string | null = null): void {
  bind.LogToFile(max_depth, filename);
}
export function LogToClipboard(max_depth = -1): void {
...
export function AcceptDragDropPayload<T>(
  type: string,
...
export function SetKeyboardFocusHere(offset = 0): void {
...
export function IsItemActive(): boolean {
  return bind.IsItemActive();
}
export function IsItemFocused(): boolean {
  return bind.IsItemFocused();
}
...
export function GetStyleColorName(idx: ImGuiCol): string {
  return bind.GetStyleColorName(idx);
}
// IMGUI_API void          SetStateStorage(ImGuiStorage* tree);
// IMGUI_API ImGuiStorage* GetStateStorage();
export function CalcListClipping(
  items_count: number,
  items_height: number,
  out_items_display_start: Bind.ImScalar<number>,
  out_items_display_end: Bind.ImScalar<number>
): void {
...
export function CalcTextSize(
  ...
  wrap_width = -1,
  out: Bind.interface_ImVec2 = new ImVec2()
): Bind.interface_ImVec2 {
  return bind.CalcTextSize(
    text_end !== null ? text.substring(0, text_end) : text,
...
export function ColorConvertU32ToFloat4(
  in_: Bind.ImU32,
  out: Bind.interface_ImVec4 = new ImVec4()
): Bind.interface_ImVec4 {
...
export function ColorConvertRGBtoHSV(
  ...
  g: number,
  b: number,
  out_h: Bind.ImScalar<number>,
  out_s: Bind.ImScalar<number>,
  out_v: Bind.ImScalar<number>
): void {
  bind.ColorConvertRGBtoHSV(r, g, b, out_h, out_s, out_v);
}
export function ColorConvertHSVtoRGB(
  h: number,
  s: number,
  v: number,
  out_r: Bind.ImScalar<number>,
  out_g: Bind.ImScalar<number>,
  out_b: Bind.ImScalar<number>
): void {
  bind.ColorConvertHSVtoRGB(h, s, v, out_r, out_g, out_b);
}
...
export function IsKeyPressed(user_key_index: number, repeat = true): boolean {
...
export function IsMouseClicked(button: number, repeat = false): boolean {
...
export function IsMouseHoveringRect(
  r_min: Readonly<Bind.interface_ImVec2>,
  r_max: Readonly<Bind.interface_ImVec2>,
  clip = true
): boolean {
...
export function GetMousePosOnOpeningCurrentPopup(
  out: Bind.interface_ImVec2 = new ImVec2()
): Bind.interface_ImVec2 {
  return bind.GetMousePosOnOpeningCurrentPopup(out);
}
export function IsMouseDragging(button = 0, lock_threshold = -1.0): boolean {
...
export function ResetMouseDragDelta(button = 0): void {
...
export function SetMouseCursor(type: ImGuiMouseCursor): void {
  bind.SetMouseCursor(type);
}
export function CaptureMouseFromApp(capture = true): void {
...
export function GetClipboardText(): string {
  return bind.GetClipboardText();
}
export function SetClipboardText(text: string): void {
  bind.SetClipboardText(text);
}
...
export function DebugCheckVersionAndDataLayout(
  ...
  return bind.DebugCheckVersionAndDataLayout(
    version_str,
    sz_io,
    sz_style,
    sz_vec2,
...
export function SetAllocatorFunctions(
  alloc_func: (sz: number, user_data: any) => number,
  free_func: (ptr: number, user_data: any) => void,
  user_data: any = null
): void {
...
export function GetHoveredIdPreviousFrame(): ImGuiID {
  return bind.GetHoveredIdPreviousFrame();
}
export function GetActiveId(): ImGuiID {
  return bind.GetActiveId();
}
export function GetActiveIdPreviousFrame(): ImGuiID {
  return bind.GetActiveIdPreviousFrame();
}
export function SetActiveId(id: ImGuiID) {
  return bind.SetActiveId(id);
}

export function GetInputTextState(id: ImGuiID): ImGuiInputTextState {
  return new ImGuiInputTextState(bind.GetInputTextState(id));
}
export function GetInputTextId(): ImGuiID {
