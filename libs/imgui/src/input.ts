...
export class Input {
  ...
  constructor() {
    ...
    this._dom_input.addEventListener('keydown', (e)=>{this.onKeydown(e as KeyboardEvent)})
    this._dom_input.addEventListener('keyup', (e)=>{this.onKeyup(e as KeyboardEvent)})
    this._dom_input.addEventListener('keypress', (e)=>{this.onKeypress(e as KeyboardEvent)})
    this._dom_input.addEventListener('compositionend', (e) => {this.onCompositionEnd(e as CompositionEvent)});
