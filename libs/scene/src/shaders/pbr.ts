...
/** @internal */
export function iblSpecularAndDiffuse(
  scope: PBInsideFunctionScope,
  f0: PBShaderExp,
  ...
  pb.func(
    ...
    function () {
      ...
      this.outSpecular = pb.mul(this.radiance, pb.add(this.t, pb.vec3(this.fab.y)), this.specularWeight);
      this.$l.FssEss = pb.add(pb.mul(this.t, this.specularWeight), this.fab.y);
      this.$l.Ems = pb.sub(1, pb.add(this.fab.x, this.fab.y));
      this.$l.Favg = pb.mul(pb.add(this.f0, pb.div(pb.sub(pb.vec3(1), this.f0), 21)), this.specularWeight);
      this.$l.FmsEms = pb.mul(
        this.Ems,
        this.FssEss,
        pb.div(this.Favg, pb.sub(pb.vec3(1), pb.mul(this.Favg, this.Ems)))
      );
      this.$l.kD = pb.mul(this.diffuse, pb.add(pb.sub(pb.vec3(1), this.FssEss), this.FmsEms));
...
export function iblSpecular(
  ...
  pb.func(
    ...
    function () {
      ...
      this.$l.kS = pb.add(this.f0, pb.mul(this.fr, pb.pow(pb.sub(1, this.NdotV), 5)));
      this.$l.t = pb.mul(this.kS, this.fab.x);
      this.$return(pb.mul(this.radiance, pb.add(this.t, pb.vec3(this.fab.y)), this.specularWeight));
    }
  );
...
/** @internal */
export function indirectClearcoatLighting(
  scope: PBInsideFunctionScope,
  f0: PBShaderExp,
  ccRadiance: PBShaderExp,
  ccNdotV: PBShaderExp | number,
  ccRoughness: PBShaderExp | number
): PBShaderExp {
  return iblSpecular(scope, f0, ccRadiance, ccNdotV, ccRoughness, 1);
}

/** @internal */
export function directClearcoatLighting(
  scope: PBInsideFunctionScope,
  NdotV: PBShaderExp,
  NdotH: PBShaderExp,
  NdotL: PBShaderExp,
  F: PBShaderExp,
  clearcoatRoughness: PBShaderExp | number
): PBShaderExp {
  const pb = scope.$builder;
  const funcName = 'pbrDirectClearcoatLighting';
  pb.func(
    funcName,
    [pb.float('NdotV'), pb.float('NdotH'), pb.float('NdotL'), pb.vec3('F'), pb.float('clearcoatRoughness')],
    function () {
...
/** @internal */
export function indirectSheenLighting(
  scope: PBInsideFunctionScope,
  NdotV: PBShaderExp,
  iblDiffuse: PBShaderExp,
...
/** @internal */
export function directSheenLighting(
  scope: PBInsideFunctionScope,
  NdotV: PBShaderExp,
  NdotL: PBShaderExp,
  NdotH: PBShaderExp,
  sheenColor: PBShaderExp,
  sheenRoughness: PBShaderExp | number
): PBShaderExp {
  const pb = scope.$builder;
