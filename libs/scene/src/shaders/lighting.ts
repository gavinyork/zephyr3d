...
export function forwardComputeLighting(
  ...
  function illumPointLight(lm: LightModel, ...args: PBShaderExp[]) {
    pb.func(
      ...
      function () {
        ...
        this.$l.falloff = pb.mul(
          this.a,
          pb.clamp(pb.sub(1, pb.div(this.dist, this.lightPositionRange.w)), 0, 1)
        );
  ...
  function illumOneLight(
    lm: LightModel,
    positionRange: PBShaderExp,
    directionCutoff: PBShaderExp,
    diffuseIntensity: PBShaderExp
  ) {
    pb.func(
