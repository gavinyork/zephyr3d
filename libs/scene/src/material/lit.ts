...
export class LitMaterial extends MeshMaterial {
  ...
  static readonly FEATURE_NORMAL_TEXTURE = 'lm_normaltexture';
  static readonly FEATURE_NORMAL_TEXCOORD_INDEX = 'lm_normaltexcoord';
  static readonly FEATURE_NORMAL_TEXTURE_MATRIX = 'lm_normal_texture_matrix';
  static readonly FEATURE_OBJECT_SPACE_NORMALMAP = 'lm_objectspace_normalmap';
