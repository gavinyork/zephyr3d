import { AbstractDevice, BindGroup, GPUProgram } from "@zephyr3d/device";
    ...
    gradientNoiseProgram = device.buildRenderProgram({
      ...
      fragment(pb){
        ...
        pb.func('noise', [pb.vec2('p')], function(){
          ...
          this.$l.noise = pb.add(pb.mul(pb.mix(pb.mix(this.tl, this.tr, this.u.x), pb.mix(this.bl, this.br, this.u.x), this.u.y), 0.5), 0.5);
