...
[Home](doc/markdown/./index.md) &gt; [@zephyr3d/scene](doc/markdown/./scene.md) &gt; [nonLinearDepthToLinear](doc/markdown/./scene.nonlineardepthtolinear.md)

## nonLinearDepthToLinear() function
...
```typescript
declare function nonLinearDepthToLinear(scope: PBInsideFunctionScope, depth: PBShaderExp, nearFar?: PBShaderExp): PBShaderExp;
```
