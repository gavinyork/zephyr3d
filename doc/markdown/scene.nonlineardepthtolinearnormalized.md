...
[Home](doc/markdown/./index.md) &gt; [@zephyr3d/scene](doc/markdown/./scene.md) &gt; [nonLinearDepthToLinearNormalized](doc/markdown/./scene.nonlineardepthtolinearnormalized.md)

## nonLinearDepthToLinearNormalized() function
...
```typescript
declare function nonLinearDepthToLinearNormalized(scope: PBInsideFunctionScope, depth: PBShaderExp, nearFar?: PBShaderExp): PBShaderExp;
```
