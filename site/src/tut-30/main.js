...
import { Scene, Application, OrbitCameraController, PerspectiveCamera, Compositor, LambertMaterial, Mesh, DirectionalLight, BoxShape, PlaneShape, TorusShape, PBRMetallicRoughnessMaterial, Tonemap, FXAA } from '@zephyr3d/scene';
