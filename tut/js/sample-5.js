...
(async function() {
    ...
    renderStates.useStencilState().enable(true).setFrontOp('keep', 'keep', 'incr').setFrontCompareFunc('always');
    ...
    device.runLoop((device)=>{
        ...
        bindGroupOutline.setValue('worldMatrix', Matrix4x4.translateLeft(Matrix4x4.scaleRight(rotateMatrix, new Vector3(1.02, 1.02, 1.02)), new Vector3(0, 0, -4)));
...
//# sourceMappingURL=sample-5.js.map
