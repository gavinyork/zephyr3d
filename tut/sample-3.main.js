...
(async function () {
  ...
  const offsets = [
    -6, -6, -18, -2, -6, -18, 2, -6, -18, 6, -6, -18, -6, -2, -18, -2, -2, -18, 2, -2, -18, 6, -2, -18, -6, 2,
    -18, -2, 2, -18, 2, 2, -18, 6, 2, -18, -6, 6, -18, -2, 6, -18, 2, 6, -18, 6, 6, -18
  ];
  const indices = [
    ...
    vertex(pb) {
      ...
      pb.main(function () {
        ...
        this.$builtins.position = pb.mul(
          this.projMatrix,
          pb.vec4(pb.add(this.worldPos.xyz, this.$inputs.offset), 1)
        );
